...
<div class="container-fluid sticky-top px-0">
  ...
  <div class="terms-header">
    <h2 class="text-center mt-4 ">Disclaimer</h2>
    <p class="text-center ms-5 me-5">The information provided on the Himland Veda website is for general informational purposes only. While we strive to ensure that the content is accurate and up-to-date, we do not guarantee the completeness or accuracy of the information.</p>
  </div>

  <!-- Terms Content -->
  <div class="container mb-5">
    <div class="terms-content mb-3">
      
      <!-- Section 1 -->
      <div class="terms-section">
        <h3>Product Use:</h3>
        <p>The products listed on this website are intended for specific health purposes. They should be used as directed and are not a substitute for professional medical advice, diagnosis, or treatment. Always consult a qualified healthcare provider before using any product, especially if you have existing health conditions, are pregnant, nursing, or administering to children.
</p>
      </div>
      ...
      <div class="terms-section">
        ...
        <p>All products are government-approved, but individual results may vary based on personal health conditions.</p>
      </div>

      <!-- Section 3 -->
      <div class="terms-section">
        <h3>No Liability: </h3>
        <p>Himland Veda and its representatives shall not be held responsible for any adverse effects or misuse of the products purchased from this website. The company is not liable for any damage or loss resulting from the use of the website or the products.</p>
      </div>

      <!-- Section 4 -->
      <div class="terms-section">
        <h3>Refund & Cancellation: </h3>
        <p> Refunds and cancellations are subject to the terms and conditions stated on the website. Requests outside the specified timeframe or without valid reasons may not be accepted.
</p>
      </div>
