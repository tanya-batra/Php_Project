...
<div class="container-fluid sticky-top px-0">
  ...
  <div class="container my-5">
    <section class="refund-cancellation-section">
        <h1 class="text-center mb-5">Refund & Cancellation Policy</h1>

        <div class="mb-4">
            <h2>Cancellation Policy</h2>
            <p>We understand that sometimes plans change. Here's our policy regarding cancellations:</p>
            <ul class="list-group">
                <li class="list-group-item">All cancellations must be made at least 48 hours prior to the scheduled service date.</li>
                <li class="list-group-item">If you cancel before 48 hours, you will receive a full refund.</li>
                <li class="list-group-item">Cancellations made within 48 hours of the service date will be eligible for a 50% refund.</li>
                <li class="list-group-item">No refunds will be provided for cancellations made on the day of the service.</li>
            </ul>
        </div>

        <div class="mb-4">
            <h2>Refund Policy</h2>
            <p>In case you're not satisfied with our service, we offer the following refund options:</p>
            <ul class="list-group">
                <li class="list-group-item">If the service provided does not meet the quality standards promised, a full refund will be processed.</li>
                <li class="list-group-item">Refunds will be initiated within 5-7 business days after approval.</li>
                <li class="list-group-item">The refund will be credited to the original payment method used during the purchase.</li>
            </ul>
        </div>

        <div class="mb-4">
            <h2>How to Request a Refund or Cancellation</h2>
            <p>To request a refund or cancel a service, please contact our support team through one of the following methods:</p>
            <ul class="list-group">
                <li class="list-group-item">Email us at <a href="mailto:info@himlandveda.com" style="color:rgb(10, 10, 83); font-weight:bold;">info@himlandveda.com</a></li>
                <li class="list-group-item">Call our customer service at <strong>+91 9463008876</strong></li>
             
            </ul>
        </div>

        <p>If you have any further questions regarding our refund or cancellation policies, feel free to reach out to our support team.</p>

        <div class="text-center">
           <a href="https://wa.me/919463008876?text=Hello,%20I%20need%20help%20tracking%20my%20order.%20My%20Order%20ID%20is%20[Your Order ID]" target="_blank" class="btn btn-success">
           Contact us 
        </a>
        </div>
    </section>
