...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Get the bill number from the form submission
    $bill_number = $_POST['bill_number'];

    // Prepare SQL query to fetch courier details
    $query = "SELECT bill_number, courier, docnumber, status FROM payments WHERE bill_number = ?";
    ...
    // If a matching record is found, fetch the courier details
    if ($result->num_rows > 0) {
        $courier_details = $result->fetch_assoc();
    } else {
        echo "<div class='alert alert-danger mt-4'>No details found for Bill Number: $bill_number</div>";
    }
...
?>
 ...
 <div class="container mt-5 mb-5">
    <div class="form-container">
        <h2 class="form-header">Delivery status</h2>
        ...
        <!-- Hidden table to display courier details -->
        <?php if (isset($courier_details)) { ?>
        <div class="mt-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td><?= $courier_details['bill_number']; ?></td>
                        <td><?= $courier_details['courier']; ?></td>
                        <td><?= $courier_details['docnumber']; ?></td>
                        <td><?= $courier_details['status']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
