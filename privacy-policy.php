...
<div class="container-fluid sticky-top px-0">
  ...
  <div class="terms-header">
    <h2 class="text-center mt-4">Privacy Policy</h2>
    <p class="text-center ms-5 me-5">At Himland Veda, we are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your personal information when you visit or make a purchase from our website.</p>
  </div>
  ...
  <div class="container">
    <div class="terms-content mb-3">
      ...
      <div class="terms-section">
        ...
        <p>  <b>Personal Information:</b> When you place an order, we collect personal details such as your name, email address, shipping address, and payment details.</p>
         <p>  <b> Browsing Data:</b>We collect information about your interaction with our site, such as IP address, browser type, and the pages you visit.</p>
      </div>

      <!-- Section 2 -->
      <div class="terms-section">
        <h3>How We Use Your Information</h3>
        <p>  <b>Order Fulfillment:</b>Your personal information is used to process and deliver your orders.</p>
         <p>  <b> Communication: </b>We may contact you via email to provide updates on your order or promotional offers.</p>
           <p>  <b> Site Improvement:  </b>Data from your site interactions helps us improve our website’s performance and user experience.</p>
      </div>

 <!-- Section 1 -->
      <div class="terms-section">
        <h3>Sharing Your Information</h3>
        <p> We do not share your personal data with third parties, except for trusted service providers (e.g., payment processors, shipping partners) necessary to fulfill your order.</p>
      ...
      <div class="terms-section">
        <h3>Data Security</h3>
        <p> We implement industry-standard measures to protect your information from unauthorized access and breaches.
Your Rights
